...
#define PIN9_BITNUM 5
#define PIN10_BITNUM 6
#define PIN7_BITNUM 6

#define PIN10_PORTREG PORTB
#define PIN9_PORTREG PORTB
#define PIN7_PORTREG PORTE

#define PIN7_DDRREG DDRB
#define PIN9_DDRREG DDRB
#define PIN10_DDRREG DDRE


// pin 9 - TMPpcm_READY                            //*Vad
// Data direction register for DAP_READY.
#define TMPpcm_READY_DDR  PIN9_DDRREG

// Port register for TMPpcm_READY.
#define TMPpcm_READY_PORT PIN9_PORTREG

// Port bit number for TMPpcm_READY. 
#define TMPpcm_READY_BIT  PIN9_BITNUM
